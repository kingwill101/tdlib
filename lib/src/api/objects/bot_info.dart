...
final class BotInfo extends TdObject {
  ...
  static BotInfo? fromJson(Map<String, dynamic>? json) {
    ...
    return BotInfo(
      ...
      menuButton: BotMenuButton.fromJson(tdMapFromJson(json['menu_button'])),
      ...
      defaultGroupAdministratorRights: ChatAdministratorRights.fromJson(
        tdMapFromJson(json['default_group_administrator_rights']),
      ),
      defaultChannelAdministratorRights: ChatAdministratorRights.fromJson(
        tdMapFromJson(json['default_channel_administrator_rights']),
      ),
      affiliateProgram: AffiliateProgramInfo.fromJson(
        tdMapFromJson(json['affiliate_program']),
      ),
      ...
      verificationParameters: BotVerificationParameters.fromJson(
        tdMapFromJson(json['verification_parameters']),
      ),
      ...
      editCommandsLink: InternalLinkType.fromJson(
        tdMapFromJson(json['edit_commands_link']),
      ),
      editDescriptionLink: InternalLinkType.fromJson(
        tdMapFromJson(json['edit_description_link']),
      ),
      editDescriptionMediaLink: InternalLinkType.fromJson(
        tdMapFromJson(json['edit_description_media_link']),
      ),
      editSettingsLink: InternalLinkType.fromJson(
        tdMapFromJson(json['edit_settings_link']),
      ),
    );
  }
