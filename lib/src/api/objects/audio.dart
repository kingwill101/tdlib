  ...
  static Audio? fromJson(Map<String, dynamic>? json) {
    ...
    return Audio(
      ...
      albumCoverMinithumbnail: Minithumbnail.fromJson(
        tdMapFromJson(json['album_cover_minithumbnail']),
      ),
      albumCoverThumbnail: Thumbnail.fromJson(
        tdMapFromJson(json['album_cover_thumbnail']),
      ),
      externalAlbumCovers: List<Thumbnail>.from(
        tdListFromJson(json['external_album_covers'])
            .map((item) => Thumbnail.fromJson(tdMapFromJson(item)))
            .whereType<Thumbnail>(),
      ),
      audio: File.fromJson(tdMapFromJson(json['audio'])),
    );
  }
